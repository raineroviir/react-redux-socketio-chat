...
/***/ function(module, exports, __webpack_require__) {
	...
	var _clientJsContainersRoot = __webpack_require__(161);

	var _clientJsContainersRoot2 = _interopRequireDefault(_clientJsContainersRoot);

	var _reactRouter = __webpack_require__(182);

	var _reactRouterLibHashHistory = __webpack_require__(246);

	var _reactRouterLibHashHistory2 = _interopRequireDefault(_reactRouterLibHashHistory);

	var _reactRouterLibBrowserHistory = __webpack_require__(248);

	var _reactRouterLibBrowserHistory2 = _interopRequireDefault(_reactRouterLibBrowserHistory);

	var _clientJsComponentsLogin = __webpack_require__(230);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/raw-loader/index.js!./chatapp.css", function() {
				var newContent = require("!!./../../node_modules/raw-loader/index.js!./chatapp.css");
...
/***/ function(module, exports) {
	...
	module.exports = ".chatapp {\n  font-family: 'Muli', 'Helvetica Neue', helvetica, arial;\n  max-width: 760px;\n  margin: 20px auto;\n  overflow: hidden;\n}\n\na {\n  text-decoration: none;\n  color: black;\n}\n\n.message-list {\n  border: 1px solid #ccf;\n  font-size: 1rem;\n  height: 400px;\n  margin: 0;\n  overflow-y: auto;\n  padding: 0;\n}\n\n.channel-list {\n  border: 1px solid #ccf;\n  font-size: 1.6rem;\n  height: 200px;\n  margin: 0;\n  overflow-y: auto;\n  padding: 0;\n}\n\n.user-list {\n  border: 1px solid #ccf;\n  font-size: 1.0rem;\n  height: 200px;\n  overflow-y: auto;\n}\n\n\n.top-bar {\n}\n\n.top-bar-button {\n}\n\n.typing-list {\n  font-size: 0.8rem;\n  opacity: 0.6;\n}\n\n.channel-section {\n  float: left;\n  width: 20%;\n}\n\n.message-section {\n  float: left;\n  width: 60%;\n  margin-left: 0.5rem;\n  margin-right: 0.5rem;\n}\n\n.user-section {\n  float: left;\n  width: 15%;\n}\n\n.message-channel-heading,\n.channel-count {\n  height: 40px;\n  margin: 0;\n}\n\n.message-list-item, .channel-list-item {\n  list-style: none;\n  padding: 0.01rem 0.01rem 0.01rem;\n}\n\n.channel-list-item {\n  border-bottom: 1px solid #ccc;\n  cursor: pointer;\n}\n\n.channel-list:hover .channel-list-item:hover {\n  background-color: #f8f8ff;\n}\n\n.channel-list:hover .channel-list-item {\n  background-color: #fff;\n}\n\n.channel-list-item.selected,\n.channel-list:hover .channel-list-item.selected,\n.channel-list:hover .channel-list-item.selected:hover {\n  background-color: #efefff;\n  cursor: default;\n}\n\n.message-user {\n  color: #66c;\n  font-size: 1rem;\n}\n\n.channel-name {\n  color: #66c;\n  font-size: 1.2rem;\n  margin: 0;\n}\n\n.message-time, .channel-time {\n  color: #aad;\n  opacity: 0.8;\n  font-size: 0.9rem;\n}\n\n.message-content, .channel-last-message {\n  clear: both;\n  font-size: 1rem;\n  padding-top: 0.1rem;\n  margin-top: -1px;\n  padding-bottom: 0.3rem;\n}\n\n.message-composer {\n  box-sizing: border-box;\n  font-family: inherit;\n  font-size: 1rem;\n  height: 2em;\n  width: 100%;\n  margin: 0.5rem 0 0;\n}\n\n.channel-composer {\n  box-sizing: border-box;\n  font-family: inherit;\n  font-size: 1rem;\n  height: 2em;\n  width: 100%;\n  margin: 0.5rem 0 0;\n}\n\n.footer, .push {\n  height: 15.5rem;\n}\n\n.wrapper {\n  min-height: 100%;\n  margin: 0 auto -15.5rem;\n}\n"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsLogout = __webpack_require__(242);

	var _componentsLogout2 = _interopRequireDefault(_componentsLogout);

	var _cookiesJs = __webpack_require__(181);
	...
	var _middlewarePromiseMiddleware = __webpack_require__(244);

	var _middlewarePromiseMiddleware2 = _interopRequireDefault(_middlewarePromiseMiddleware);

	var _reduxLogger = __webpack_require__(245);

	var _reduxLogger2 = _interopRequireDefault(_reduxLogger);

	var createStoreWithMiddleware = (0, _redux.applyMiddleware)(_reduxLogger2['default'], _middlewarePromiseMiddleware2['default'])(_redux.createStore);
	...
	function renderRoutes(history) {
	  return _react2['default'].createElement(
	    ...
	    _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(_reactRouter.Route, { path: '/chat', component: _componentsChat2['default'], onEnter: requireAuth }),
	      ...
	      _react2['default'].createElement(
	        _reactRouter.Route,
	        { path: '/logout', component: _componentsLogout2['default'] },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsUserAPIUtils = __webpack_require__(175);

	var UserAPIUtils = _interopRequireWildcard(_utilsUserAPIUtils);

	var _reactRouter = __webpack_require__(182);

	var _reactRedux = __webpack_require__(163);

	var _actionsActions = __webpack_require__(179);
	...
	var Register = (function (_Component) {
	  function Register(props, context) {
	    ...
	    _get(Object.getPrototypeOf(_Register.prototype), 'constructor', this).call(this, props, context);
	    this.state = {
	      username: '',
	      password: '',
	      confirmPassword: ''
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              ...
	              null,
	              'Password',
	              _react2['default'].createElement('input', { type: 'password', name: 'password', value: this.state.password, onChange: this.handleChange.bind(this) })
	            )
	          ),
	          _react2['default'].createElement(
	            'section',
	            ...
	            _react2['default'].createElement(
	              ...
	              null,
	              'Confirm Password',
	              _react2['default'].createElement('input', { type: 'password', name: 'confirm-password', value: this.state.confirmPassword, onChange: this.handleChange.bind(this) })
	            )
	          ),
	          _react2['default'].createElement(
	            'section',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsCreateAll = __webpack_require__(164);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createProvider = __webpack_require__(165);

	var _createProvider2 = _interopRequireDefault(_createProvider);

	var _createProvideDecorator = __webpack_require__(167);

	var _createProvideDecorator2 = _interopRequireDefault(_createProvideDecorator);

	var _createConnector = __webpack_require__(169);

	var _createConnector2 = _interopRequireDefault(_createConnector);

	var _createConnectDecorator = __webpack_require__(173);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsCreateStoreShape = __webpack_require__(166);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsGetDisplayName = __webpack_require__(168);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsShallowEqual = __webpack_require__(170);

	var _utilsShallowEqual2 = _interopRequireDefault(_utilsShallowEqual);

	var _utilsIsPlainObject = __webpack_require__(171);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsShallowEqualScalar = __webpack_require__(174);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function register(user) {
	  ...
	  return new Promise(function (resolve, reject) {
	    _superagent2['default'].post('/api/create_user').send(user).end(function (err, res) {
	      if (err) {
	        console.log(err);
	        reject(res.body || err);
	      } else {
	        resolve(res.body.username);
	        _cookiesJs2['default'].set('eat', res.body.eat);
	      }
	    });
	  });
	}
	...
	function logout() {
	  return new Promise(function (resolve) {
	    resolve(_cookiesJs2['default'].set('eat', ''));
	  });
	}
	...
	function getAllMessages(actions) {

	  return new Promise(function (resolve, reject) {
	    _superagent2['default'].get('api/messages').end(function (err, res) {
	      if (err) {
	        console.log(err);
	        reject(res.body || err);
	      } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function register(user) {
	  return {
	    types: [types.AUTH_REGISTER, types.AUTH_REGISTER_SUCCESS, types.AUTH_REGISTER_FAIL],
...
/***/ function(module, exports) {
	...
	var CHANGE_CHANNEL = 'CHANGE_CHANNEL';
	...
	exports.LOGIN = LOGIN;
	var AUTH_LOAD = 'AUTH_LOAD';
	exports.AUTH_LOAD = AUTH_LOAD;
	var AUTH_LOAD_SUCCESS = 'AUTH_LOAD_SUCCESS';
	exports.AUTH_LOAD_SUCCESS = AUTH_LOAD_SUCCESS;
	var AUTH_LOAD_FAIL = 'AUTH_LOAD_FAIL';
	...
	var AUTH_LOGIN_FAIL = 'AUTH_LOGIN_FAIL';
	exports.AUTH_LOGIN_FAIL = AUTH_LOGIN_FAIL;
	...
	var AUTH_LOGOUT_FAIL = 'AUTH_LOGOUT_FAIL';
	exports.AUTH_LOGOUT_FAIL = AUTH_LOGOUT_FAIL;
	var AUTH_REGISTER_SUCCESS = 'AUTH_REGISTER_SUCCESS';
	exports.AUTH_REGISTER_SUCCESS = AUTH_REGISTER_SUCCESS;
	var AUTH_REGISTER = 'AUTH_REGISTER';
	exports.AUTH_REGISTER = AUTH_REGISTER;
	var AUTH_REGISTER_FAIL = 'AUTH_REGISTER_FAIL';

	exports.AUTH_REGISTER_FAIL = AUTH_REGISTER_FAIL;
	var TYPING = 'TYPING';
	exports.TYPING = TYPING;
	var STOP_TYPING = 'STOP_TYPING';

	exports.STOP_TYPING = STOP_TYPING;
	var ADD_USER_TO_CHANNEL = 'ADD_USER_TO_CHANNEL';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _URLUtils = __webpack_require__(189);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NavigationTypes = __webpack_require__(197);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _keymirror = __webpack_require__(198);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsComposeMiddleware = __webpack_require__(221);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsMapValues = __webpack_require__(212);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _composeMiddleware = __webpack_require__(221);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _channels2 = __webpack_require__(226);

	var _channels3 = _interopRequireDefault(_channels2);

	exports.channels = _channels3['default'];

	var _activeChannel2 = __webpack_require__(227);

	var _activeChannel3 = _interopRequireDefault(_activeChannel2);

	exports.activeChannel = _activeChannel3['default'];

	var _auth2 = __webpack_require__(223);

	var _auth3 = _interopRequireDefault(_auth2);

	exports.auth = _auth3['default'];

	var _typers2 = __webpack_require__(228);

	var _typers3 = _interopRequireDefault(_typers2);

	exports.typers = _typers3['default'];

	var _channelUserList2 = __webpack_require__(229);

	var _channelUserList3 = _interopRequireDefault(_channelUserList2);

	exports.channelUserList = _channelUserList3['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	function info() {
	  ...
	  switch (action.type) {
	    case _constantsActionTypes.AUTH_LOAD:
	      return _extends({}, state, {
	        loading: true
	      });
	    case _constantsActionTypes.AUTH_LOAD_SUCCESS:
	      return _extends({}, state, {
	        loading: false,
	        loaded: true,
	        user: action.result
	    ...
	    case _constantsActionTypes.AUTH_LOAD_FAIL:
	      return _extends({}, state, {
	        loading: false,
	        loaded: false,
	        error: action.error
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _strftime = __webpack_require__(225);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function channels(state, action) {
	  ...
	  switch (action.type) {
	    case _constantsActionTypes.ADD_CHANNEL:
	      return [].concat(_toConsumableArray(state), [{
	        name: action.channel,
	        id: state.length === 0 ? 0 : state[state.length - 1].id + 1
	      }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function activeChannel(state, action) {
	  if (state === undefined) state = initialState;

	  switch (action.type) {
	    case _constantsActionTypes.CHANGE_CHANNEL:
	      return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = channelUserList;
	...
	function channelUserList(state, action) {
	  if (state === undefined) state = initialState;

	  switch (action.type) {
	    case _constantsActionTypes.ADD_USER_TO_CHANNEL:
	      if (state.filter(function (user) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Login = (function (_Component) {
	  function Login(props, context) {
	    ...
	    _get(Object.getPrototypeOf(_Login.prototype), 'constructor', this).call(this, props, context);
	    this.state = {
	      username: '',
	      password: ''
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MessageComposer = __webpack_require__(232);

	var _MessageComposer2 = _interopRequireDefault(_MessageComposer);

	var _MessageListItem = __webpack_require__(233);

	var _MessageListItem2 = _interopRequireDefault(_MessageListItem);

	var _Channels = __webpack_require__(234);
	...
	var _TypingListItem = __webpack_require__(238);

	var _TypingListItem2 = _interopRequireDefault(_TypingListItem);

	var _UserListItem = __webpack_require__(239);
	  ...
	  _createClass(Chat, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      socket.on('typing bc', function (username) {
	        return actions.typing(username);
	      });
	      socket.on('stop typing bc', function (username) {
	        return actions.stopTyping(username);
	      });
	    ...
	    value: function componentDidUpdate() {
	      var messageList = _react2['default'].findDOMNode(this.refs.messageList);
	    ...
	    value: function render() {
	      ...
	      var typers = _props2.typers;
	      var channelUserList = _props2.channelUserList;

	      var filteredMessages = messages.filter(function (message) {
	        return message.channelID === activeChannel.id;
	      });
	      // const filteredTypers = typing.filter(user => user.typing === true)
	      var filteredChannelUserList = channelUserList;
	      return _react2['default'].createElement(
	        'main',
	        null,
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(_Channels2['default'], { onClick: this.changeActiveChannel.bind(this), channels: channels, actions: actions })
	        ),
	        _react2['default'].createElement(
	          'div',
	          ...
	          _react2['default'].createElement(
	            ...
	            filteredMessages.map(function (message) {
	              return _react2['default'].createElement(_MessageListItem2['default'], { message: message, key: message.id, user: user, actions: actions });
	            })
	          ),
	          _react2['default'].createElement(_MessageComposer2['default'], { activeChannel: activeChannel, user: user, onSave: this.handleSave.bind(this) }),
	          ...
	          typers.length === 2 && _react2['default'].createElement(
	            'span',
	            { className: 'typing-list' },
	            _react2['default'].createElement(_TypingListItem2['default'], { username: typers[0], key: 2 }),
	            _react2['default'].createElement(
	              'span',
	              null,
	              ' and '
	            ),
	            _react2['default'].createElement(_TypingListItem2['default'], { username: typers[1], key: 3 }),
	            _react2['default'].createElement(
	              'span',
	              null,
	              ' are typing'
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            'ul',
	            { className: 'user-list' },
	            filteredChannelUserList.map(function (user) {
	              return _react2['default'].createElement(_UserListItem2['default'], { user: user, key: user.id });
	            })
	          )
	        )
	      );
	...
	var ChatContainer = (function () {
	  function ChatContainer() {
	    _classCallCheck(this, _ChatContainer);
	  }

	  var _ChatContainer = ChatContainer;

	  _createClass(_ChatContainer, [{
	    key: 'render',
	    value: function render() {
	      var _props3 = this.props;
	      var messages = _props3.messages;
	      var channels = _props3.channels;
	      var activeChannel = _props3.activeChannel;
	      var dispatch = _props3.dispatch;
	      var user = _props3.user;
	      var typers = _props3.typers;

	      var actions = (0, _redux.bindActionCreators)(Actions, dispatch);
	      return _react2['default'].createElement(Chat, _extends({}, this.props, { actions: actions }));
	    }
	  }]);

	  ChatContainer = (0, _reactRedux.connect)(function (state) {
	    return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MessageComposer = (function (_Component) {
	  function MessageComposer(props, context) {
	    ...
	    _get(Object.getPrototypeOf(MessageComposer.prototype), 'constructor', this).call(this, props, context);
	    this.state = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MessageListItem = (function (_Component) {
	  ...
	  _inherits(MessageListItem, _Component);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ChannelComposer = __webpack_require__(236);

	var _ChannelComposer2 = _interopRequireDefault(_ChannelComposer);

	var _ChannelListItem = __webpack_require__(237);
	...
	var ChannelContainer = (function (_Component) {
	  function ChannelContainer() {
	    ...
	    _get(Object.getPrototypeOf(ChannelContainer.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _inherits(ChannelContainer, _Component);

	  _createClass(ChannelContainer, [{
	    key: 'handleSaveChannel',
	    value: function handleSaveChannel(channel) {
	      if (channel.length !== 0) {
	    ...
	    key: 'handleClick',
	    value: function handleClick(channel) {
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            ...
	            filteredChannels.map(function (channel) {
	              return _react2['default'].createElement(_ChannelListItem2['default'], _extends({ channel: channel, key: channel.id }, actions, { onShow: _this.handleClick.bind(_this) }));
	            })
	          ),
	          _react2['default'].createElement(_ChannelComposer2['default'], { onSave: this.handleSaveChannel.bind(this) })
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChannelComposer = (function (_Component) {
	  function ChannelComposer(props, context) {
	    _classCallCheck(this, ChannelComposer);

	    _get(Object.getPrototypeOf(ChannelComposer.prototype), 'constructor', this).call(this, props, context);
	    this.state = {
	      name: this.props.name || ''
	    };
	  }

	  _inherits(ChannelComposer, _Component);

	  _createClass(ChannelComposer, [{
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement('textarea', {
	    ...
	    key: 'handleSubmit',
	    value: function handleSubmit(event) {
	      var channel = event.target.value.trim();
	      if (event.which === 13) {
	        event.preventDefault();
	...
	exports['default'] = ChannelComposer;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChannelListItem = (function (_Component) {
	  ...
	  _inherits(ChannelListItem, _Component);
	  ...
	  _createClass(ChannelListItem, [{
	    ...
	    value: function render() {
	      ...
	      var _props = this.props;
	      var selectedChannel = _props.channel;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TypingListItem = (function (_Component) {
	  function TypingListItem() {
	    _classCallCheck(this, TypingListItem);

	    _get(Object.getPrototypeOf(TypingListItem.prototype), "constructor", this).apply(this, arguments);
	  }

	  _inherits(TypingListItem, _Component);

	  _createClass(TypingListItem, [{
	    key: "render",
	    value: function render() {
	      ...
	      return _react2["default"].createElement(
	        "span",
	        { className: "typing-list-item" },
	        username
	      );
	    }
	  }]);

	  return TypingListItem;
	})(_react.Component);
	  ...
	  _createClass(Footer, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        'div',
	        null,
	        'Follow me at github.com/raineroviir'
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = (function (_Component) {
	  ...
	  _createClass(_App, [{
	    key: 'render',
	    value: function render() {
	      var eat = _cookiesJs2['default'].get('eat');
	      var _props = this.props;
	      var user = _props.user;
	      var dispatch = _props.dispatch;
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'section',
	          { className: 'top-bar' },
	          eat && _react2['default'].createElement(
	            'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Logout = (function (_React$Component) {
	  function Logout() {
	    ...
	    _get(Object.getPrototypeOf(_Logout.prototype), 'constructor', this).apply(this, arguments);
	  }
	  ...
	  Logout = (0, _reactRedux.connect)(function (state) {
	    return {
	      user: state.auth.user
	    };
	  })(Logout) || Logout;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DOMHistory2 = __webpack_require__(247);
